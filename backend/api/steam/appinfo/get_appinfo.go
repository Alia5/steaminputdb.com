...
type AppInfoRequest struct {
	AppID             uint32 `path:"app_id" required:"true"`
...
func registerGetAppInfo(a huma.API, dal db.DAL, registry huma.Registry, sc client.Client, useMemCache bool, cache *memcache.Cache) {
	huma.Register(
		a,
		huma.Operation{
			Method:      http.MethodGet,
			Path:        "/v1/steam/appinfo/{app_id}",
