...
const (
	...
	ControllerTypeSteamFrameControllerPair ControllerType = "controller_steamframe_pair"
...
var controllerNiceNames map[ControllerType]string = map[ControllerType]string{
	...
	ControllerTypeSteamFrameControllerPair: "Steam Frame Controller Pair",
...
const (
	...
	ControllerTypeNumberSteamFrameControllerPair ControllerTypeNumber = 21
...
var eControllerTypeMap = map[ControllerTypeNumber]ControllerType{
	...
	ControllerTypeNumberSteamFrameControllerPair: ControllerTypeSteamFrameControllerPair,
